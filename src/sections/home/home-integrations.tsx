...
export function HomeIntegrations({ sx, ...other }: BoxProps) {
  const renderDescription = () => (
    <SectionTitle
      caption="Tech Stack"
      title="Built with"
      txtGradient="Modern Tools"
      description={
        <>
          <Box component="span" sx={{ mb: 1, display: 'block' }}>
            Powered by Casper Network, Supabase, and Next.js for a robust and scalable payment infrastructure.
          </Box>
          ...
          >
            * CEP-18 token standard support.
            <br />* Real-time updates via Supabase.
          </Box>
        </>
      }
